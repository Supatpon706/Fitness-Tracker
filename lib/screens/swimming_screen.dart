...
class SwimmingScreen extends StatefulWidget {
  ...
  SwimmingScreen({required this.data});

  @override
  _SwimmingScreenState createState() => _SwimmingScreenState();
}
              ...
              onPressed: () {
                setState(() {
                  widget.data[index] = ActivityData(
                    ...
                    type: 'swimming', // Correct type for SwimmingScreen
                  );
                });
                Navigator.of(context).pop(); // Close dialog
              },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            // Wrapping the swimming.png image in a yellow circular container
            Container(
              ...
              child: Image.asset(
                'assets/image/swimming.png',  // Ensure the image path is correct
                width: 100,
                height: 100,
              ),
            ),
            SizedBox(height: 10),
            Text('Today you swam for...',
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: ListTile(
                      leading: Image.asset(
                        'assets/image/swimming.png', // Use the swimming.png image
                        width: 40,
                        height: 40,
                      ),
                      title: Text(
