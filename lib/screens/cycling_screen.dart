...
class CyclingScreen extends StatefulWidget {
  ...
  CyclingScreen({required this.data});
              ...
              onPressed: () {
                setState(() {
                  widget.data[index] = ActivityData(
                    ...
                    type: 'cycling', // Correct type for CyclingScreen
                  );
                });
                Navigator.of(context).pop(); // Close dialog
              },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            // Wrapping the bicycle.png image in a yellow circular container
            Container(
              ...
              child: Image.asset(
                'assets/image/bicycle.png',
                width: 100,
                height: 100,
              ),
            ),
            SizedBox(height: 10),
            Text('Today you cycled for...',
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: ListTile(
                      leading: Image.asset(
                        'assets/image/bicycle.png', // Use the bicycle.png image
                        width: 40,
                        height: 40,
                      ),
                      title: Text(
